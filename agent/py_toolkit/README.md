...
```python
from ouestcharlie import ManifestStore, PhotoEntry
...
```python
from ouestcharlie import XmpStore
...
See [py_toolkit_LLD.md](py_toolkit_LLD.md) for the detailed low-level design.
...
- [OuEstCharlie HLD](../../HLD.md)
- [Agent LLD Rationale](../agent_LLD_rationale.md)
