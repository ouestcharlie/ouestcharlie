...
import pytest
from ouestcharlie.backend import backend_from_config
from ouestcharlie.backends.local import LocalBackend
from ouestcharlie.schema import ConfigurationError
